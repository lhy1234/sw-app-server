...
public class ThreeDesKeyUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("返回一个定长的带因子的固定的随机字符串(只包含大小写字母、数字):");
        System.out.println(generateStringByKey(32, channel));
        System.out.println("返回一个定长的随机字符串(只包含大小写字母、数字):     64位---------"  );
        System.out.println(generateString(64));
